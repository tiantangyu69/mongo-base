	...
	<tr>
		...
		<table cellspacing="0" cellpadding="0" width="480px" border="0">
			...
			<tr>
				...
				<td style="background:url(<%=basePath%>static/common/images/error/bg.gif);"><div align="center"><font class="p6"><a href="<%=basePath%>login.action">返回首页</a>　 　|　 <a  href="javascript:history.go(-1)">返回出错页</a>　 　|　　 <a href="javascript:void(window.close());">关闭本页</a></font> </div></td>
